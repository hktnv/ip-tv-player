...
private fun diagnosticsRows(
    ...
    return listOf(
        ...
        "Bağlantı" to diagnostics.ms("playlist_import_connection_open_ms"),
        "Stream okuma" to diagnostics.ms("playlist_import_line_read_ms"),
        "M3U parse" to diagnostics.ms("playlist_import_parse_ms"),
        "Sınıflandırma" to diagnostics.ms("playlist_import_classification_ms"),
        "DB toplam" to diagnostics.ms("playlist_import_db_total_ms"),
        "Bekleme/boşta" to diagnostics.ms("playlist_import_idle_wait_ms"),
